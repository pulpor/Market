...
export async function fetchAllIndicators(): Promise<Indicator[]> {
  console.log('🔄 Buscando todos os indicadores...');
  ...
  console.log('📈 S&P 500:', sp500.price);
  console.log('📈 Dow Jones:', dow.price);
  console.log('📈 Nasdaq:', nasdaq.price);
