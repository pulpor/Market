  ...
  useEffect(() => {
    const loadIndexData = async () => {
      try {
        ...
        const portfolioHistory = getHistoryWithDiff(user?.id);
        console.log("📊 Histórico carregado:", portfolioHistory);
        ...
        console.log("📊 Dados da API:", { ipca: ipcaData.length, selic: selicData.length, cdi: cdiData.length });
        ...
        console.log("📈 Retorno mensal da carteira:", portfolioMonthly);
        ...
        console.log("📅 Meses:", last12Months);
